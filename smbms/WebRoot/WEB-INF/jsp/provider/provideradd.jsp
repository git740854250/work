...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/openAdd" enctype="multipart/form-data">
			<input type="hidden" name="method" value="add">
                ...
                <div>
                    <label for="attachs">企业营业执照路径：</label>
                    <input type="file" name="attachs" id="companyLicPicPath" value=""> 
                </div>
                <div>
                    <label for="attachs">组织机构代码证路径：</label>
                    <input type="file" name="attachs" id="orgCodePicPath" value=""> 
                </div>
